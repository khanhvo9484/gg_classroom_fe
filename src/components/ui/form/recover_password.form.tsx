        ...
        <FormikProvider value={formik}>
          <Box sx={{ p: 2 }}>
            ...
            <Typography
              ...
              component="div"
            >
              Để giữ an toàn cho tài khoản của bạn, K3 Learning muốn đảm bảo
              rằng bạn chính là người đang cố đăng nhập
            </Typography>
          </Box>
          <Box
            component="img"
            src={
              "https://ssl.gstatic.com/accounts/account-recovery-email-pin.gif"
            }
        ...
        <Box sx={{ p: 2 }}>
          ...
          <Box sx={{ p: 2 }}>
            <Typography
              ...
              component="div"
            >
              K3 Learning vừa gửi email chứa đường dẫn khôi phục mật khẩu đến{" "}
              {values.email}. Vui lòng sử dụng được dẫn đó để tạo lại mật khẩu.
            </Typography>
          </Box>
        </Box>
      </Box>
